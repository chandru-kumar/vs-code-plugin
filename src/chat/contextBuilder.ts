...
function buildSystemPrompt(): string {
  ...
  return [
    ...
    '4. EDIT: use apply_diff for targeted changes (or write_file for new files). Edits',
    '   are STAGED and shown to the user as a reviewable diff — you do not need to ask',
    '   permission, but never claim a change is applied; say it is proposed for review.',
